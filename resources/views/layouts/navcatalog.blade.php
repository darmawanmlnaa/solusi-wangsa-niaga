          ...
          <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
            ...
            <div class="offcanvas-body">
              <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="/"><i class="bi bi-clipboard2-fill pe-2 pb-2"></i>Tentang</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="/"><i class="bi bi-hdd-rack-fill pe-2 pb-2"></i>Layanan</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="/"><i class="bi bi-grid-1x2-fill pe-2 pb-2"></i>Mitra</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="/"><i class="bi bi-telephone-outbound-fill pe-2 pb-2"></i>Kontak</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#"><i class="bi bi-columns-gap pe-2 pb-2"></i>Katalog</a>
                </li>
                <li class="nav-item">
