...
@section('contents')
    ...
    <div class="display-image-wrapper scrollspy" id="home">
        ...
        <div class="greeting-text">
          <p class="welcome">Integrated Clinic</p>
          <p class="branding">IN - CLINIC</p>
        </div>
    </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-10 offset-md-1">
              <p class="desc">IN-CLINIC adalah sistem manajemen informasi klinik yang mudah digunakan dimana saja kapan saja, dengan inovasi fitur nontifikasi antrian, terintegrasi dengan BPJS dan dompet digital sebagai PAYMENT GATEWAY</p>
            </div>
          </div>
        </div>
    </section>
    ...
    <section id="services" class="services scrollspy">
        <div class="container">
            <div class="row">
                <p class="title text-center">Layanan</p>
    ...
    {{-- <section id="portfolio" class="portfolio scrollspy">
        <div class="container">
            <div class="row">
                <p class="title text-center">Mitra</p>
                <p class="desc text-center">Telah Diimplementasikan Dibeberapa Rumah Sakit</p>

                <div class="col-md-4 card-wrapper mb-3">
                <div class="card" style="width: 18rem;">
                    <img src="assets/portfolio/rsud-mohsaleh.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                ...
                <div class="col-md-4 card-wrapper mb-3">
                <div class="card" style="width: 18rem;">
                    <img src="assets/portfolio/rsia-amanah.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                ...
                <div class="col-md-4 card-wrapper mb-3">
                <div class="card" style="width: 18rem;">
                    <img src="assets/portfolio/rsia-fatimah.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
  ...
  <div class="container">
    <div class="row" style="display: flex; justify-content: center;">
      ...
      <div class="col-md-4 pb-3">
        <div class="card" style="width: 18rem;">
          <div class="card-body">
            ...
            <p class="card-text">Pembayaran /tahun</p>
            <a href="https://wa.me/6281221987868" class="btn text-white" style="background-color: #378b29;">Hubungi Kami</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 pb-3">
        <div class="card" style="width: 18rem;">
          <div class="card-body">
            <p class="card-title">/ Pasien</p>
            <p class="card-text">Pembayaran /pasien</p>
            <a href="https://wa.me/6281221987868" class="btn text-white" style="background-color: #378b29;">Hubungi Kami</a>
          </div>
        </div>
      </div>
                      ...
                      @csrf
                        <div class="row">
                            ...
                            <div class="col-md-12 pt-4">
                                <div class="form-group">
                                    <input type="submit" value="Send Message" class="btn text-white" style="background-color: #378b29;">
